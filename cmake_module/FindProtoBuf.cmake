...
if(EXISTS ${PROTOBUF_PROTOC_EXECUTABLE})
  ...
  message(FATAL_ERROR "Could not find PROTOBUF Compiler") # sudo apt-get install protobuf-compiler
endif()

if(PROTOBUF_FOUND)
  message (STATUS "PROTOBUF_LIBRARIES ${PROTOBUF_LIBRARIES} found")
else()
...
# Usage:
#   liyee_protobuf_generate_cpp(<output_dir> <proto_srcs> <proto_hdrs> <proto_files>)
function(liyee_protobuf_generate_cpp output_dir proto_srcs proto_hdrs)
  if(NOT ARGN)
    message(SEND_ERROR "Error: liyee_protobuf_generate_cpp() called without any proto files")
    return()
  endif()
